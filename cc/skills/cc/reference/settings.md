...
| `default` | Globally configured model |
...
- [ ] Set `defaultMode: "acceptEdits"` for automation
- [ ] Pre-allow needed tools in `permissions.allow`
- [ ] Deny dangerous commands (`rm -rf`, `curl`, etc)
- [ ] Disable telemetry for CI/CD
